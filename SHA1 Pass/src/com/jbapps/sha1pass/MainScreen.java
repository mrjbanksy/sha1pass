    ...
    implements View.OnClickListener
{
    ...
    {
        String input =
            sentenceField.getText().toString() + wordField.getText().toString();
    ...
    private byte[] generateHMAC(byte[] hashData)
    {
        ...
        SecretKeySpec secret =
            new SecretKeySpec(input.getBytes(), mac.getAlgorithm());
        try
        {
            mac.init(secret);
        }
